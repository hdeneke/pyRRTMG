...
def gen_dynlib(fc,fflags,build_dir,ext,deps):
...
build_ext('src_f','_rrtmg')
if newer('src_f/_rrtmg.so','src/pyrrtmg/_rrtmg.so'):
    os.remove('src/pyrrtmg/_rrtmg.so')
    shutil.move('src_f/_rrtmg.so','src/pyrrtmg/')

if __name__ == "__main__":
    from numpy.distutils.core import setup
    
    ext_rrtmg = Extension( '_rrtmg', _rrtmg_src_list )
    setup(
        name = "pyrrtmg",
